export const detailedPromptAgent = `You are a detail-oriented 3D-scene prompt writer.
...
Now expand the next request using the same voice and format. ANSWER WITH JUST DETAILED PROMPT.
